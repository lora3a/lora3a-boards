...
SHELL_COMMAND(i2c_acquire, "Get access to the I2C bus", cmd_i2c_acquire);
SHELL_COMMAND(i2c_release, "Release to the I2C bus", cmd_i2c_release);
#ifdef MODULE_PERIPH_I2C_RECONFIGURE
SHELL_COMMAND(i2c_gpio, "Re-configures I2C pins to GPIO mode and back.", cmd_i2c_gpio);
#endif
SHELL_COMMAND(i2c_read_reg, "Read byte from register", cmd_i2c_read_reg);
SHELL_COMMAND(i2c_read_regs, "Read bytes from registers", cmd_i2c_read_regs);
SHELL_COMMAND(i2c_read_byte, "Read byte from the I2C device", cmd_i2c_read_byte);
SHELL_COMMAND(i2c_read_bytes, "Read bytes from the I2C device", cmd_i2c_read_bytes);
SHELL_COMMAND(i2c_write_byte, "Write byte to the I2C device", cmd_i2c_write_byte);
SHELL_COMMAND(i2c_write_bytes, "Write bytes to the I2C device", cmd_i2c_write_bytes);
