...
#define TCXO_PWR_PIN        GPIO_PIN(PA, 19)     /**< 32 MHz TCXO 1ppm oscillator for radio enable */
...
// definizione pin protoanemometro
#define PROG_1 GPIO_PIN(PA, 10)
#define PROG_2 GPIO_PIN(PA, 07)
#define NRST_1 GPIO_PIN(PA, 16)
#define NRST_2 GPIO_PIN(PA, 11)
